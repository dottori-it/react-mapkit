...
var load = _interopDefault(require('little-loader'))
...
var createCoordinateSpan = function createCoordinateSpan(
  latitudeDelta,
  longitudeDelta,
) {
  return new mapkit.CoordinateSpan(latitudeDelta, longitudeDelta)
}
var createCoordinateRegionFromValues = function createCoordinateRegionFromValues(
  region,
) {
...
var propsToMapConstructionOptions = function propsToMapConstructionOptions(
  _ref,
) {
  ...
  return _extends(
    {
      visibleMapRect:
        visibleMapRect && createMapRect.apply(void 0, visibleMapRect),
...
var propsToMarkerConstructionOptions = function propsToMarkerConstructionOptions(
  _ref2,
) {
...
var useMap = function useMap(defaultOptions) {
  ...
  return {
    ...
    setRotation: React.useCallback(
      function (rotationValue, isAnimated) {
    ...
    setCenter: React.useCallback(
      function (centerValue, isAnimated) {
        if (isAnimated === void 0) {
          isAnimated = false
        }
        ...
        if (map) {
          map.setCenterAnimated(
            createCoordinate.apply(void 0, centerValue),
            isAnimated,
          )
        }
      },
    ...
    setVisibleMapRect: React.useCallback(
      function (visibleMapRect, isAnimated) {
        if (isAnimated === void 0) {
          isAnimated = false
        }
        ...
        if (map) {
          map.setVisibleMapRectAnimated(
            createMapRect.apply(void 0, visibleMapRect),
            isAnimated,
          )
        }
      },
...
exports.MapkitProvider = MapkitProvider
exports.Marker = Marker
exports.useMap = useMap
//# sourceMappingURL=react-mapkit.cjs.development.js.map
